            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-x-12 gap-y-4 md:gap-12">
              <div>
                <div className="flex items-center mb-4">
                  ...
                  <h1 className="text-2xl md:text-4xl ">Residence</h1>
                </div>
              ...
              <div>
                ...
                <div className="flex flex-col">
                  <a href="/" className="text-xl w-fit mb-4">
                    {" "}
                    Home{" "}
                  </a>
                  <a className="text-xl w-fit mb-4" href="/services">
                    Services
                  </a>
                  <a className="text-xl w-fit mb-4" href="/apartments">
                    Apartments
                  </a>
                  <a className="text-xl w-fit mb-4" href="/about">
                    About
                  </a>
                  <a className="text-xl w-fit" href="/contactus">
                    Contact Us
                  </a>
                </div>
              </div>
              <div>
                <div>
                  ...
                  <input
                    ...
                    className="my-4 footer-back-trans focus:outline-none"
                  />
                </div>
                <div>
