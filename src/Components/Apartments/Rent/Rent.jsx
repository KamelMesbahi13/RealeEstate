    ...
    <>
      <div>
        <div className="container">
          <div className="text-center mb-8 mt-14 md:mt-28 md:mb-16">
                    ...
                    <div className="bg-white rounded-sm pb-4">
                      ...
                      <div className="p-4">
                        ...
                        <div className="mt-2">
                          ...
                          <button className="py-2 px-10 bg-[transparent] border text-black mt-4 border-black hover:text-white">
                            <a className="text-xl" href={prop.details_url}>
                              More
                            </a>
                          </button>
                        </div>
