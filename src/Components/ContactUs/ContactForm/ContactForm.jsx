                  ...
                  <form action="#">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          className="mt-2 border-b-[1px] border-b-third-color focus:outline-none pl-1"
                          type="text"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          className="mt-4 border-b-[1px] border-b-third-color focus:outline-none pl-1"
                        />
                ...
                <div className="p-8">
                  ...
                  <div className="mt-0 md:mt-16">
                    <div className="flex items-center">
                      <p>
                        <GoLocation className="mr-4 text-2xl" />
                      </p>
                    ...
                    <div className="flex items-center my-8">
                      <p>
                        <BsPhone className="mr-4 text-2xl" />
                      </p>
                    ...
                    <div className="flex items-center">
                      <p>
                        <GoMail className="mr-4 text-2xl" />
                      </p>
